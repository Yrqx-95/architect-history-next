-- Rollback graduation kait workshop batch 009 only.
...
INSERT INTO architect_rollback VALUES
  ('22c1a5f8-b0ee-5d7b-9196-a8c1bd0505b6'::uuid, 'junya-ishigami');
...
INSERT INTO building_rollback VALUES
  ('989ffbda-1f55-5e50-bf9b-45759994fa1b'::uuid, 'kait-workshop');
...
INSERT INTO image_rollback VALUES
  ('2f3ba479-63e2-5962-a767-58963b1ddd41'::uuid, '989ffbda-1f55-5e50-bf9b-45759994fa1b'::uuid, 'https://commons.wikimedia.org/wiki/File:KAIT_Workshop_Junya_Ishigami_internal_view.JPG');
...
INSERT INTO profile_rollback VALUES
  ('CASE-034', '989ffbda-1f55-5e50-bf9b-45759994fa1b'::uuid);
...
INSERT INTO assignment_rollback VALUES
  ('989ffbda-1f55-5e50-bf9b-45759994fa1b'::uuid, 'university');
...
BEGIN
  ...
  IF external_relations <> 0 THEN
    RAISE EXCEPTION 'Rollback refused: found % external relations added after graduation-kait-workshop-batch-009', external_relations;
  END IF;
END $$;
