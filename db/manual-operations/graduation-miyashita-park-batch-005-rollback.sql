-- Rollback graduation miyashita park batch 005 only.
...
INSERT INTO architect_rollback VALUES
  ('49dee726-4fa3-5f25-a7d0-0a0dfb2a8d71'::uuid, 'takenaka-corporation-nikken-sekkei');
...
INSERT INTO building_rollback VALUES
  ('2558b8fa-1cb6-55f4-9f32-710d3005ea74'::uuid, 'miyashita-park');
...
INSERT INTO image_rollback VALUES
  ('b442816c-953f-5f0c-9e79-186c0b2c5f6a'::uuid, '2558b8fa-1cb6-55f4-9f32-710d3005ea74'::uuid, 'https://commons.wikimedia.org/wiki/File:Miyashita_Park_2025_May_26_various_01.jpg');
...
INSERT INTO profile_rollback VALUES
  ('CASE-040', '2558b8fa-1cb6-55f4-9f32-710d3005ea74'::uuid);
...
INSERT INTO assignment_rollback VALUES
  ('2558b8fa-1cb6-55f4-9f32-710d3005ea74'::uuid, 'mixed-use'),
  ('2558b8fa-1cb6-55f4-9f32-710d3005ea74'::uuid, 'retail'),
  ('2558b8fa-1cb6-55f4-9f32-710d3005ea74'::uuid, 'public-space');
...
BEGIN
  ...
  IF external_relations <> 0 THEN
    RAISE EXCEPTION 'Rollback refused: found % external relations added after graduation-miyashita-park-batch-005', external_relations;
  END IF;
END $$;
