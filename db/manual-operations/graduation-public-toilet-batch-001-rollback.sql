-- Rollback graduation public toilet batch 001 only.
...
INSERT INTO building_rollback VALUES
  ('3e94d879-84d3-5cb7-934f-fa08bf50e0d7'::uuid, 'nabeshima-shoto-park-toilet');
...
INSERT INTO image_rollback VALUES
  ('3dcb24c5-bdad-53d3-830d-6dfe615d06eb'::uuid, '3e94d879-84d3-5cb7-934f-fa08bf50e0d7'::uuid, 'https://commons.wikimedia.org/wiki/File:Shoto_park_2302.jpg');
...
INSERT INTO profile_rollback VALUES
  ('CASE-044', '3e94d879-84d3-5cb7-934f-fa08bf50e0d7'::uuid);
...
INSERT INTO assignment_rollback VALUES
  ('3e94d879-84d3-5cb7-934f-fa08bf50e0d7'::uuid, 'public-toilet'),
  ('3e94d879-84d3-5cb7-934f-fa08bf50e0d7'::uuid, 'public-space');
...
BEGIN
  ...
  IF external_relations <> 0 THEN
    RAISE EXCEPTION 'Rollback refused: found % external relations added after graduation-public-toilet-batch-001', external_relations;
  END IF;
END $$;
