-- Rollback graduation shiroiya hotel batch 006 only.
...
INSERT INTO building_rollback VALUES
  ('6ee56b07-11ef-5d25-a7a8-cfce9e76bf2f'::uuid, 'shiroiya-hotel');
...
INSERT INTO image_rollback VALUES
  ('3127db3e-0bc3-59a6-ad3b-ddb527166ae2'::uuid, '6ee56b07-11ef-5d25-a7a8-cfce9e76bf2f'::uuid, 'https://commons.wikimedia.org/wiki/File:Shiroiya_Hotel.jpg');
...
INSERT INTO profile_rollback VALUES
  ('CASE-028', '6ee56b07-11ef-5d25-a7a8-cfce9e76bf2f'::uuid);
...
INSERT INTO assignment_rollback VALUES
  ('6ee56b07-11ef-5d25-a7a8-cfce9e76bf2f'::uuid, 'hotel'),
  ('6ee56b07-11ef-5d25-a7a8-cfce9e76bf2f'::uuid, 'retail');
...
BEGIN
  ...
  IF external_relations <> 0 THEN
    RAISE EXCEPTION 'Rollback refused: found % external relations added after graduation-shiroiya-hotel-batch-006', external_relations;
  END IF;
END $$;
