-- Graduation Yu no Eki Ohyu batch 008: reviewed canonical entities and relations.
-- Generated by scripts/prepare-graduation-library-batch-002.mjs (GRADUATION_REVIEW_BATCH=yu-no-eki-ohyu-008).
...
BEGIN
  IF to_regclass('public.graduation_case_profiles') IS NULL
    ...
    RAISE EXCEPTION 'Graduation Yu no Eki Ohyu batch 008 prerequisites are missing';
  END IF;
END $$;
...
INSERT INTO building_seed VALUES
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'CASE-033', 'yu-no-eki-ohyu', '大湯道路休息站', 'Yu no Eki Ohyu', '湯の駅おおゆ', '51797239-be38-4dbd-9d7e-e413ddf3c78a'::uuid, 'kengo-kuma', 2018, 'published', '鹿角', '日本', 'JP', 'transportation', 'https://kkaa.co.jp/en/project/yu-no-eki-ohyu/');
...
INSERT INTO image_seed VALUES
  ('f0b47ee2-f7cd-591a-a578-676c4fbc7356'::uuid, 'b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'yu-no-eki-ohyu', 'CASE-033', '/images/graduation/cases/case-033-yu-no-eki-ohyu.jpg', '掬茶', 'Wikimedia Commons', 'CC BY-SA 4.0', 'https://commons.wikimedia.org/wiki/File:Roadside_Station_Oyu_20180915a.jpg', 'exterior', true);
...
INSERT INTO profile_seed VALUES
  ('CASE-033', 'b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'yu-no-eki-ohyu', '店铺、咖啡、露天剧场、公园、足汤和生态水景被放在同一大屋顶下。', NULL, 'Yu no Eki Ohyu is a reference case for reading Design topic: 温泉街, Design topic: 足汤, local food, tourism. It can inform thesis thinking about mixed programs, operation, and place-making.', '温泉街の足湯、食、観光案内を組み合わせた小さな滞在拠点。短時間の休憩を地域交流へつなげる設計として読める。', ARRAY['温泉街', '足汤', '地域食', '旅游', '健康']::text[], '{}'::text[], ARRAY['Design topic: 温泉街', 'Design topic: 足汤', 'local food', 'tourism', 'health']::text[], ARRAY['温泉街', '足湯', '地域食', '観光', '健康']::text[], NULL, NULL, 'https://kkaa.co.jp/en/project/yu-no-eki-ohyu/', 'published');
...
INSERT INTO assignment_seed VALUES
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'yu-no-eki-ohyu', 'transport-hub', true, 1.000, 'https://kkaa.co.jp/en/project/yu-no-eki-ohyu/', 'Kengo Kuma and Associates identifies Yu no Eki Ohyu as a completed 2018 Akita project of 1,026 square metres and one floor. The architect describes it as a community center combining a shop, cafe, open-air theater, park, footbath and biotope beneath one large roof. Kazuno City identifies the same facility as Michi-no-Eki Oyu at Towada Oyu Aza Nakayachi 19, with roadside-station parking, charging, 24-hour toilets, market, cafe and footbath. The attached open-air theater is one secondary space and does not make the whole facility a theatre.', '2026-07-12T00:00:00Z'::timestamptz),
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'yu-no-eki-ohyu', 'community-center', false, 1.000, 'https://kkaa.co.jp/en/project/yu-no-eki-ohyu/', 'Kengo Kuma and Associates identifies Yu no Eki Ohyu as a completed 2018 Akita project of 1,026 square metres and one floor. The architect describes it as a community center combining a shop, cafe, open-air theater, park, footbath and biotope beneath one large roof. Kazuno City identifies the same facility as Michi-no-Eki Oyu at Towada Oyu Aza Nakayachi 19, with roadside-station parking, charging, 24-hour toilets, market, cafe and footbath. The attached open-air theater is one secondary space and does not make the whole facility a theatre.', '2026-07-12T00:00:00Z'::timestamptz),
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'yu-no-eki-ohyu', 'retail', false, 1.000, 'https://kkaa.co.jp/en/project/yu-no-eki-ohyu/', 'Kengo Kuma and Associates identifies Yu no Eki Ohyu as a completed 2018 Akita project of 1,026 square metres and one floor. The architect describes it as a community center combining a shop, cafe, open-air theater, park, footbath and biotope beneath one large roof. Kazuno City identifies the same facility as Michi-no-Eki Oyu at Towada Oyu Aza Nakayachi 19, with roadside-station parking, charging, 24-hour toilets, market, cafe and footbath. The attached open-air theater is one secondary space and does not make the whole facility a theatre.', '2026-07-12T00:00:00Z'::timestamptz),
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'yu-no-eki-ohyu', 'public-space', false, 1.000, 'https://kkaa.co.jp/en/project/yu-no-eki-ohyu/', 'Kengo Kuma and Associates identifies Yu no Eki Ohyu as a completed 2018 Akita project of 1,026 square metres and one floor. The architect describes it as a community center combining a shop, cafe, open-air theater, park, footbath and biotope beneath one large roof. Kazuno City identifies the same facility as Michi-no-Eki Oyu at Towada Oyu Aza Nakayachi 19, with roadside-station parking, charging, 24-hour toilets, market, cafe and footbath. The attached open-air theater is one secondary space and does not make the whole facility a theatre.', '2026-07-12T00:00:00Z'::timestamptz);
...
BEGIN
  IF (SELECT count(*) FROM architect_seed) <> 1
    ...
    RAISE EXCEPTION 'Graduation Yu no Eki Ohyu batch 008 seed count mismatch';
  END IF;
  ...
  WHERE slug = ANY (ARRAY['transport-hub', 'community-center', 'retail', 'public-space']::text[]) AND is_active = true;
  ...
  INTO conflicts;
  IF conflicts <> 0 THEN
    RAISE EXCEPTION 'Graduation Yu no Eki Ohyu batch 008 requires empty target keys; found % conflicts', conflicts;
  END IF;
END $$;
...
BEGIN
  IF (SELECT count(*) FROM public.architects target JOIN architect_seed seed USING (id, slug) WHERE seed.is_new) <> 0
    ...
    RAISE EXCEPTION 'Graduation Yu no Eki Ohyu batch 008 post-write verification failed';
  END IF;
END $$;
