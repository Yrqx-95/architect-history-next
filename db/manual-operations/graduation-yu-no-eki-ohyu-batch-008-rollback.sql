-- Rollback graduation yu no eki ohyu batch 008 only.
...
INSERT INTO building_rollback VALUES
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'yu-no-eki-ohyu');
...
INSERT INTO image_rollback VALUES
  ('f0b47ee2-f7cd-591a-a578-676c4fbc7356'::uuid, 'b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'https://commons.wikimedia.org/wiki/File:Roadside_Station_Oyu_20180915a.jpg');
...
INSERT INTO profile_rollback VALUES
  ('CASE-033', 'b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid);
...
INSERT INTO assignment_rollback VALUES
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'transport-hub'),
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'community-center'),
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'retail'),
  ('b038e5a2-c92f-5fa5-96bf-6605e1422e79'::uuid, 'public-space');
...
BEGIN
  ...
  IF external_relations <> 0 THEN
    RAISE EXCEPTION 'Rollback refused: found % external relations added after graduation-yu-no-eki-ohyu-batch-008', external_relations;
  END IF;
END $$;
