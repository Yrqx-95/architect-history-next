...
Generated: 2026-07-08T13:58:40.852Z
...
- Cases using local case images: 45/139
- Cases using remote images: 55/139
- Cases using placeholder image: 39/139
- Cases with explicit image source URL: 100/139
- Graduation image manifest entries: 45
- Graduation image retry queue entries: 16
...
Dedicated retry queue: CASE-044, CASE-045, CASE-046, CASE-047, CASE-050, CASE-051, CASE-052, CASE-053, CASE-054, CASE-055, CASE-058, CASE-060, CASE-061, CASE-071, CASE-074, CASE-081

## Published Readiness

- Published cases: 100
- Published cases using local images: 45/100
- Published cases using remote images: 55/100
...
Published placeholder cases: none
Published cases missing image metadata: none
...
- Retry queued remote Commons images only when expanding image coverage; use the retry queue in slow 1-2 item batches, starting with CASE-044 and CASE-045.
