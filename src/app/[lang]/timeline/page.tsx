        ...
        <section className="section border-t border-subtle pt-10 sm:pt-12">
          ...
          {decades.map(([decade, bldgs], eraIdx) => (
            <Reveal key={decade} delay={eraIdx * 0.05}>
              <section id={`decade-${decade}`} className="mb-4 inline-block w-full break-inside-avoid rounded-md border border-subtle bg-surface p-4 shadow-semantic-card scroll-mt-28">
