...
const overlays: Record<string, ArchitectContentOverlay> = {
  ...
  'hassan-fathi': {
    ...
    sources: [
      { title: 'Right Livelihood: Hassan Fathy', url: 'https://rightlivelihood.org/the-change-makers/find-a-laureate/hassan-fathy/' },
  ...
  'michelangelo': {
    ...
    sources: [
      ...
      { title: 'Biblioteca Medicea Laurenziana: Michelangelo’s vestibule and reading room', url: 'https://www.bmlonline.it/en/visita-in-breve/' },
  ...
  'charles-rennie-mackintosh': {
    ...
    sources: [
      ...
      { title: 'National Trust for Scotland: The Mackintosh Tearooms', url: 'https://www.nts.org.uk/visit/places/the-mackintosh-tearooms' },
  ...
  'mvrdv': catalogArchitectProfile('mvrdv', { zh: 'MVRDV', ja: 'MVRDV', en: 'MVRDV' }, { zh: '数据、密度与城市情景', ja: 'データ、密度、都市シナリオ', en: 'data, density, and urban scenarios' }, { title: 'MVRDV: About', url: 'https://www.mvrdv.com/about' }),
  ...
  'pierre-chareau': catalogArchitectProfile('pierre-chareau', { zh: '皮埃尔·夏洛', ja: 'ピエール・シャロー', en: 'Pierre Chareau' }, { zh: '玻璃、金属与室内构造', ja: 'ガラス、金属、室内構成', en: 'glass, metal, and interior construction' }, { title: 'Centre Pompidou: Pierre Chareau', url: 'https://www.centrepompidou.fr/fr/ressources/personne/cjyyKbM' }),
  'studio-mumbai': catalogArchitectProfile('studio-mumbai', { zh: 'Studio Mumbai', ja: 'スタジオ・ムンバイ', en: 'Studio Mumbai' }, { zh: '现场制作与工匠协作', ja: '現場制作と職人協働', en: 'making on site and craft collaboration' }, { title: 'Studio Mumbai', url: 'https://studiomumbai.com/' }),
  ...
  'coelacanth-kh': catalogArchitectProfile('coelacanth-kh', { zh: 'Coelacanth K&H Architects', ja: 'コエラカントK&H', en: 'Coelacanth K&H Architects' }, { zh: '日常尺度与住宅类型', ja: '日常の尺度と住宅類型', en: 'everyday scale and housing type' }, { title: 'Japan Architects: Coelacanth K&H Architects', url: 'https://www.japan-architects.com/en/coelacanth-kandh-architects-tokyo/about' }),
  'kw-hg-architects': catalogArchitectProfile('kw-hg-architects', { zh: 'kw+hg architects', ja: 'kw+hg architects', en: 'kw+hg architects' }, { zh: '紧凑空间与城市改造', ja: 'コンパクトな空間と都市改修', en: 'compact space and urban renewal' }, { title: 'kw+hg architects', url: 'https://kwhg.co.jp/' }),
  ...
  'peter-behrens': catalogArchitectProfile('peter-behrens', { zh: '彼得·贝伦斯', ja: 'ペーター・ベーレンス', en: 'Peter Behrens' }, { zh: '工业设计、企业形象与现代构造', ja: '工業デザイン、企業像、近代構法', en: 'industrial design, corporate identity, and modern construction' }, { title: 'Bauhaus Kooperation: AEG Turbine Hall', url: 'https://bauhauskooperation.de/en/knowledge/the-bauhaus/works/architecture/aeg-turbine-hall-berlin/' }),
  'lina-gotmeh': catalogArchitectProfile('lina-gotmeh', { zh: '莉娜·戈特梅', ja: 'リナ・ゴットメ', en: 'Lina Ghotmeh' }, { zh: '考古学、材料记忆与低碳建造', ja: '考古学、素材の記憶、低炭素建設', en: 'archaeology, material memory, and low-carbon construction' }, { title: 'Lina Ghotmeh Architecture: About', url: 'https://www.linaghotmeh.com/en/about/' }),
  ...
  'alejandro-zaera-polo': catalogArchitectProfile('alejandro-zaera-polo', { zh: '亚历杭德罗·萨埃拉-波洛', ja: 'アレハンドロ・サエラ＝ポロ', en: 'Alejandro Zaera-Polo' }, { zh: '表皮、政治经济与全球城市', ja: '表皮、政治経済、グローバル都市', en: 'envelope, political economy, and global city' }, { title: 'AZPML: About', url: 'https://azpml.com/about-us/' }),
