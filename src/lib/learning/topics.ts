...
export const learningTopics: LearningTopic[] = [
  ...
  { id: 'road-access-obligation', slug: 'road-access-obligation', category: 'code', level: 'foundation', orderIndex: 40, japaneseTerm: '接道義務', reading: 'せつどうぎむ', ...draftGovernance },
  {
    ...
    reading: 'どうろしゃせんせいげん',
    sourceNotes: [
      'Referenced class materials: 法規Ⅱ_演習_2026前期.pdf and 法規Ⅱ_アンダーライン_法令集2025年版.pdf. Scope: 高さ制限 1〜5 and 高さ制限５ 解答の穴埋めキーワード. No full problem statements, answer text, or scanned pages are reproduced.',
    ],
    ...draftGovernance,
  },
  {
