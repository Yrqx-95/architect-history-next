...
export function isProbablySimplifiedChinese(text: string): boolean {
  return /建筑|现代|主义|文艺|复兴|单体|航站|空间|体验|垃圾|发电|滑雪|享乐|可持续|向阳|巨树|悬挑|阳台|从中心|登机口|安检|钢|混凝土|巨型柱|办公建筑|文化建筑|交通建筑|商业建筑|生态建筑|当代建筑|参数化设计|雕塑建筑|屋顶花园|自由平面|水平带窗|均匀漫射|室内|组织|设计|详细图纸|波尔图|葡萄牙|华盛顿|美国|广州|首尔|布拉格|捷克|韩国|法国|印度|西班牙|英国|哥本哈根|丹麦|圣路易斯|巴西利亚|巴西|罗马|梵蒂冈|芝加哥|直岛|[现义艺复兴单间线动发电场乐阳树规则这与为门体从达过机飞极效钢壳柱厅检径办务态雕塑尔华顿韩广岛层园绕长续围匀满细纸设]/.test(text)
}
